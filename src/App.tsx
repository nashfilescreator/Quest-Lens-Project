    ...
    if ((this as any).state.hasError) {
      return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-background text-center p-6 text-txt-main">
          ...
          <button onClick={() => { window.location.reload(); }} className="px-6 py-3 bg-primary text-white font-bold rounded-xl uppercase tracking-wider shadow-lg">Restart App</button>
        </div>
      );
    }
    return children;
...
export default function App() {
  ...
  }, [isTeamContribution, contributeToTeamMission, scannerMode, activeQuest, activeStoryStep, processQuestCompletion, handleDiscovery, closeModal, setIsCameraOpen, setIsTeamContribution, setCompletionData, setToast, openModal]);
