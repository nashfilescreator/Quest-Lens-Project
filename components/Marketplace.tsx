      ...
      <div className="px-6 py-6">
        ...
        <div className="grid grid-cols-2 gap-5">
            {filteredItems.map(item => {
                ...
                return (
                <div key={item.id} className={`flex flex-col rounded-[2.5rem] p-3 shadow-lg hover:shadow-xl transition-all duration-300 group border overflow-hidden relative ${
                    isPowerup ? 'bg-gradient-to-br from-blue-900/20 to-cyan-900/20 border-blue-500/30' : 'bg-gradient-to-br from-purple-900/20 to-pink-900/20 border-purple-500/30'
                }`}>
                    ...
                    <div className="px-2 mb-4 text-center">
                        <span className={`text-[9px] font-black uppercase tracking-widest mb-1 block ${
                            isPowerup ? 'text-blue-400' : 'text-purple-400'
                        }`}>
                            {item.category}
                        </span>
                    ...
                    <div className="mt-auto relative z-10">
                        {isOwned ? (
                            ...
                            <button 
                                ...
                                disabled={!canAfford}
                                className={`w-full py-3 font-black text-[10px] uppercase tracking-widest rounded-2xl flex items-center justify-center gap-2 transition-all shadow-md ${
                                canAfford 
