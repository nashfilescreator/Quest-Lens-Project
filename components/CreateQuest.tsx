...
const CreateQuest: React.FC<CreateQuestProps> = ({ onQuestCreated, onCancel, initialData, editingQuest, userStats }) => {
  ...
  const handleManualSubmit = () => {
      ...
      const finalQuest: Quest = {
          ...
          coverImage: mCover || `https://image.pollinations.ai/prompt/${encodeURIComponent(mTarget || mTitle + " beautiful photo")}?width=800&height=450&nologo=true`,
